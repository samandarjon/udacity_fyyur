...
class Venue(db.Model):
    ...
    @property
    def complete(self):
        past_shows = service.get_past_shows_at_venue(self.id)
        upcoming_shows = service.get_upcoming_shows_at_venue(self.id)
        return {
            'id': self.id,
            'name': self.name,
            'genres': self.genres,
...
class Artist(db.Model):
    ...
    @property
    def complete(self):
        past_shows = service.get_past_artist_shows(self.id)
        upcoming_shows = service.get_upcoming_artist_shows(self.id)
        return {
            'id': self.id,
            'name': self.name,
            'genres': self.genres,
